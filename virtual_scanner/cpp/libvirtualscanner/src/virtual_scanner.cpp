...
void VirtualScanner::calc_views() {
  ...
  view_dir_[6] << Vector3f(1.0, 1.0, 0.0).normalized();
  view_dir_[7] << Vector3f(1.0, -1.0, 0.0).normalized();
  view_dir_[8] << Vector3f(-1.0, 1.0, 0.0).normalized();
  view_dir_[9] << Vector3f(-1.0, -1.0, 0.0).normalized();
  view_dir_[10] << Vector3f(1.0, 0.0, 1.0).normalized();
  view_dir_[11] << Vector3f(1.0, 0.0, -1.0).normalized();
  view_dir_[12] << Vector3f(-1.0, 0.0, 1.0).normalized();
  view_dir_[13] << Vector3f(-1.0, 0.0, -1.0).normalized();
  view_dir_[14] << Vector3f(0.0, 1.0, 1.0).normalized();
  view_dir_[15] << Vector3f(0.0, 1.0, -1.0).normalized();
  view_dir_[16] << Vector3f(0.0, -1.0, 1.0).normalized();
  view_dir_[17] << Vector3f(0.0, -1.0, -1.0).normalized();
  view_dir_[18] << Vector3f(1.0, 1.0, 1.0).normalized();
  view_dir_[19] << Vector3f(-1.0, 1.0, 1.0).normalized();
  view_dir_[20] << Vector3f(1.0, -1.0, 1.0).normalized();
  view_dir_[21] << Vector3f(1.0, 1.0, -1.0).normalized();
  view_dir_[22] << Vector3f(-1.0, -1.0, 1.0).normalized();
  view_dir_[23] << Vector3f(1.0, -1.0, -1.0).normalized();
  view_dir_[24] << Vector3f(-1.0, 1.0, -1.0).normalized();
  view_dir_[25] << Vector3f(-1.0, -1.0, -1.0).normalized();
  view_dir_[26] = (Vector3f(bbMax_[0], bbMax_[1], bbMax_[2]) - center).normalized();
  view_dir_[27] = (Vector3f(bbMax_[0], bbMin_[1], bbMax_[2]) - center).normalized();
  view_dir_[28] = (Vector3f(bbMin_[0], bbMax_[1], bbMax_[2]) - center).normalized();
  view_dir_[29] = (Vector3f(bbMin_[0], bbMin_[1], bbMax_[2]) - center).normalized();
  view_dir_[30] = (Vector3f(bbMax_[0], bbMax_[1], bbMin_[2]) - center).normalized();
  view_dir_[31] = (Vector3f(bbMax_[0], bbMin_[1], bbMin_[2]) - center).normalized();
  view_dir_[32] = (Vector3f(bbMin_[0], bbMax_[1], bbMin_[2]) - center).normalized();
  view_dir_[33] = (Vector3f(bbMin_[0], bbMin_[1], bbMin_[2]) - center).normalized();
