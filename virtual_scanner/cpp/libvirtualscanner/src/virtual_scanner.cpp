...
void VirtualScanner::calc_views() {
  ...
  view_dir_[6] << Vector3f(1.0, 1.0, 0.0);
  view_dir_[7] << Vector3f(1.0, -1.0, 0.0);
  view_dir_[8] << Vector3f(-1.0, 1.0, 0.0);
  view_dir_[9] << Vector3f(-1.0, -1.0, 0.0);
  view_dir_[10] << Vector3f(1.0, 0.0, 1.0);
  view_dir_[11] << Vector3f(1.0, 0.0, -1.0);
  view_dir_[12] << Vector3f(-1.0, 0.0, 1.0);
  view_dir_[13] << Vector3f(-1.0, 0.0, -1.0);
  view_dir_[14] << Vector3f(0.0, 1.0, 1.0);
  view_dir_[15] << Vector3f(0.0, 1.0, -1.0);
  view_dir_[16] << Vector3f(0.0, -1.0, 1.0);
  view_dir_[17] << Vector3f(0.0, -1.0, -1.0);
  view_dir_[18] << Vector3f(1.0, 1.0, 1.0);
  view_dir_[19] << Vector3f(-1.0, 1.0, 1.0);
  view_dir_[20] << Vector3f(1.0, -1.0, 1.0);
  view_dir_[21] << Vector3f(1.0, 1.0, -1.0);
  view_dir_[22] << Vector3f(-1.0, -1.0, 1.0);
  view_dir_[23] << Vector3f(1.0, -1.0, -1.0);
  view_dir_[24] << Vector3f(-1.0, 1.0, -1.0);
  view_dir_[25] << Vector3f(-1.0, -1.0, -1.0);
